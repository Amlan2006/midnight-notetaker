 ...
 * notetaker contracts on Midnight.
 *
...
import { DeployedNoteProvider } from './contexts';
...
// CONTRACT_ADDRESS placeholder — replace after deployment:
...
ReactDOM.createRoot(document.getElementById('root') as HTMLElement).render(
  <React.StrictMode>
    ...
    <ThemeProvider theme={theme}>
      <DeployedNoteProvider logger={logger}>
        <App />
      </DeployedNoteProvider>
    </ThemeProvider>
  </React.StrictMode>,
);
